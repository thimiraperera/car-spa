...
-- Testimonials
INSERT INTO testimonials (quote, customer_name, detail, rating, is_active, sort_order) VALUES ('Used the Engine Oil Flush before my service and the difference is real: smoother idle and the old oil came out black as tar. Will order again.', 'Kasun Perera', '2 weeks ago', 5, 1, 0);
INSERT INTO testimonials (quote, customer_name, detail, rating, is_active, sort_order) VALUES ('Headlight Polish brought my 10-year-old Aqua''s lights back to crystal clear in 15 minutes. Night driving feels safe again. Fast delivery to Kandy too!', 'Nadeesha Fernando', '1 month ago', 5, 1, 1);
INSERT INTO testimonials (quote, customer_name, detail, rating, is_active, sort_order) VALUES ('The AC spray removed a musty smell that three service centres couldn''t fix. Whole cabin smells fresh. Excellent products and friendly support on WhatsApp.', 'Ruwan Jayasuriya', '2 months ago', 5, 1, 2);
INSERT INTO testimonials (quote, customer_name, detail, rating, is_active, sort_order) VALUES ('Ride to work every day and my chain used to squeal within a week. Chain Lube keeps it quiet a lot longer, and it doesn''t fling grease all over the rim like the cheap stuff did.', 'Priyantha Wickramasinghe', '6 days ago', 5, 1, 3);
INSERT INTO testimonials (quote, customer_name, detail, rating, is_active, sort_order) VALUES ('Had rust spots forming on the underbody after last monsoon. Rust Off took care of it in one afternoon and the car has been parked outside since with no new spots.', 'Chamari Ratnayake', '3 weeks ago', 5, 1, 4);
INSERT INTO testimonials (quote, customer_name, detail, rating, is_active, sort_order) VALUES ('Brake Cleaner does exactly what it says, cuts through brake dust fast. Only reason it''s not five stars is the can ran out quicker than I expected on a full service.', 'Dinesh Abeysekera', '1 month ago', 4, 1, 5);
INSERT INTO testimonials (quote, customer_name, detail, rating, is_active, sort_order) VALUES ('Used Insta Glaze before a wedding we were driving the car for. Paint looked like it just left the showroom. So many compliments that day, ordering a second tub already.', 'Nilmini Silva', '1 month ago', 5, 1, 6);
INSERT INTO testimonials (quote, customer_name, detail, rating, is_active, sort_order) VALUES ('Car was running hot on the Matara expressway stretch every time. Did a proper Radiator Flush and the temperature gauge has stayed exactly where it should since.', 'Ashan Gunasekera', '2 months ago', 5, 1, 7);
INSERT INTO testimonials (quote, customer_name, detail, rating, is_active, sort_order) VALUES ('Throttle response felt sluggish after years of city driving. Throttle Body Cleaner brought back the smoothness, feels like a different car pulling away from lights now.', 'Iresha Kodikara', '3 months ago', 5, 1, 8);
INSERT INTO testimonials (quote, customer_name, detail, rating, is_active, sort_order) VALUES ('One Step Rubbing Compound took out swirl marks I thought were permanent from an automatic car wash. Took some elbow grease but the result was worth it.', 'Sampath Herath', '4 months ago', 5, 1, 9);
